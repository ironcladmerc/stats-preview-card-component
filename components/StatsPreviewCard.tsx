function StatsPreviewCard() {
    return (
        <main className="flex flex-col md:flex-row-reverse text-white w-1/2 my-10 md:w-2/3 md:max-w-screen-md">
            <div className="bg-softViolet rounded-t-2xl md:rounded-t-none md:rounded-r-sm md:flex-1">
                <img
                    src="/image-header-mobile.jpg"
                    className="mix-blend-hard-light rounded-t-2xl md:hidden"
                    alt="image"
                />
                <img
                    src="/image-header-desktop.jpg"
                    className="hidden mix-blend-hard-light rounded-t-2xl md:h-full md:flex md:rounded-r-sm md:object-cover"
                    alt="image"
                />
            </div>
            <div className="bg-darkDesaturatedBlue p-10 text-center rounded-b-2xl md:rounded-none md:flex-1 md:text-left">
